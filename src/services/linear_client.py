    ...
    issues = [
        {
            "id": "I1",
            "identifier": "APP-101",
            "title": "Implement walking skeleton",
            "state": {"name": "In Progress"},
            "assignee": {"name": "CTO"},
            "url": "https://example.local/APP-101",
        },
        {
            "id": "I2",
            "identifier": "APP-102",
            "title": "User interviews — recruit 10",
            "state": {"name": "Todo"},
            "assignee": {"name": "CEO"},
            "url": "https://example.local/APP-102",
        },
        {
            "id": "I3",
            "identifier": "APP-103",
            ...
            "state": {"name": "Todo"},
            "assignee": {"name": "CXO"},
            "url": "https://example.local/APP-103",
        },
    ]
    ...
    if USE_MOCK or not LINEAR_API_KEY:
        return {
            ...
            "issue": {
                ...
                "identifier": "APP-104",
                "title": title,
                "url": "https://example.local/APP-104",
            },
        }
